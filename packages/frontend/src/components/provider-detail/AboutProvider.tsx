...
export function AboutProvider({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
      <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">About This Provider</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm text-slate-500 dark:text-slate-400">New Patients</p>
        ...
        {entityType && (
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400">Practice Type</p>
              <p className="font-medium text-slate-900 dark:text-white">{practiceType}</p>
            </div>
          </div>
        )}
        ...
        {languages && languages.length > 0 && (
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-slate-900 dark:text-white">{languages.join(', ')}</p>
            </div>
          </div>
        )}
      </div>
