  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="none"
      />
      <circle cx="90" cy="95" r="2" className="fill-gray-400" />

      {/* Small decorative dots */}
      <circle cx="145" cy="60" r="4" className="fill-primary-200" />
      <circle cx="55" cy="140" r="3" className="fill-primary-200" />
      <circle cx="160" cy="120" r="5" className="fill-gray-200" />

      {/* X marks to indicate "not found" */}
      <g className="stroke-gray-300" strokeWidth="2" strokeLinecap="round">
