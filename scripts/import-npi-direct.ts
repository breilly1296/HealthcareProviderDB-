...
const TAXONOMY_MAPPINGS: Record<string, string> = {
  '207RE0101X': 'ENDOCRINOLOGY',
  '207RI0011X': 'ENDOCRINOLOGY',
  '261QE0700X': 'ENDOCRINOLOGY',
  '207RR0500X': 'RHEUMATOLOGY',
  '261QR0401X': 'RHEUMATOLOGY',
...
function getSpecialtyCategory(taxonomyCode: string): string | null {
  return TAXONOMY_MAPPINGS[taxonomyCode] || null;
}

function isRelevantProvider(record: NPIRecord): boolean {
  for (let i = 1; i <= 15; i++) {
